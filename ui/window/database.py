...
class DatabaseWindow(TkinterWindow):
    ...
    def create_menu(self):
        ...
        self.reports_menu.add_command(label="Paylog (CSV)", command=None)
        self.reports_menu.add_command(label="Employee Directory (CSV)", command=self.event_handlers['export>employees'])
        self.reports_menu.add_command(label="Employee Directory (PDF)", command=self.event_handlers['export>pdf_employees'])
